...
public class ConvocatoryEditJInternalFrame extends javax.swing.JInternalFrame {
    ...
    private void jButtonConvocatoryUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConvocatoryUpdateActionPerformed
        try {
            ...
            // Convocatory update
            Convocatory convocatory = new Convocatory(id, name, description, startDate, endDate, status, documentsTypes);
            ConvocatoryController.update(id, convocatory);

            Dialog.info("Convocatoria actualizado correctamente", "Info");
        } catch (Exception e) {
            Log.error(e);
